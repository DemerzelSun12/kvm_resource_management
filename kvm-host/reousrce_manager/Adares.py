...
writer = csv.writer(f)
writer.writerow(["Iterator","Vmid","Mems","Mem_usage","CPUs","CPU_usage"])
...
class LinUCB:
    def __init__(self,vm_num,arm):
        ...
        self.curr_mem = [1400]*self.num
        self.curr_cpu = [2]*self.num
        self.arm = arm

        self.vm_domain = {1: "ubuntu18.04-05", 2: "ubuntu18.04-06", 3: "ubuntu18.04-08",
                          4: "ubuntu18.04-09",
                          5: "ubuntu18.04-10", 6: "ubuntu18.04-11", 7: "ubuntu18.04-12", 8: "ubuntu18.04-13",
                          9: "ubuntu18.04-14",
                          10: "ubuntu18.04-15", 11: "ubuntu18.04-16", 12: "ubuntu18.04-17", 13: "ubuntu18.04-18",
                          14: "ubuntu18.04-19", 15: "ubuntu18.04-20"}
        self.ip = {1: "192.168.122.195", 2: "192.168.122.196", 3: "192.168.122.198",
                   4: "192.168.122.199",
                   5: "192.168.122.200", 6: "192.168.122.201", 7: "192.168.122.202", 8: "192.168.122.203",
                   9: "192.168.122.204",
                   10: "192.168.122.205", 11: "192.168.122.206", 12: "192.168.122.207", 13: "192.168.122.208",
                   14: "192.168.122.209", 15: "192.168.122.210"}
    ...
    def reword_function(self,feature,arm):
        ...
        mem_nums = self.curr_mem
        for i in range(self.num):
            writer.writerow([self.step,i,mem_nums[i],mem_usage[i],cpu_nums[i],cpu_usage[i]])
...
for i in range(200):
    ...
    pre_bad = is_bad
    is_bad = UCB.reword_function(UCB.feature,best_arm)
    time.sleep(2)
