...
net_pid=$(ps -axu|grep net_init|grep -v "grep"|awk -F " " '{print $2}')
http_pid=$(ps -axu|grep http_load|grep -v "grep"|awk -F " " '{print $2}')
iperf_pid=$(ps -axu|grep iperf -m 1|grep -v "grep"|awk -F " " '{print $2}')
restart_pid=$(ps -axu|grep restart.sh|grep -v "grep"|awk -F " " '{print $2}')
train_pid=$(ps -axu|grep train.sh|grep -v "grep"|awk -F " " '{print $2}')
dacapo_pid=$(ps -axu|grep dacapo_test|grep -v "grep"|awk -F " " '{print $2}')
